...
class ComplexReLU(nn.Module):
    ...
    def __init__(self, negative_slope=0.0, mode="real", bias_shape=None, scale=1.0): # pragma: no cover
...
class ComplexActivation(nn.Module):
    ...
    def __init__(self, activation, mode="cartesian", bias_shape=None): # pragma: no cover
