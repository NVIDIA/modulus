...
from modulus.models.sfno.contractions import _contract_diagonal, _contract_dhconv, _contract_sep_diagonal, _contract_sep_dhconv
...
def get_contract_fun(weight, implementation='reconstructed', separable=False, operator_type='diagonal'):
