...
class OceanMSE(th.nn.MSELoss):
    ...
    def __init__(
        ...
        ----------
        lsm_file: str
            Location of the land sea mask
        open_dict: dict
            Parameters to pass to the xarray.open_dataset method
        selection: dict
            Dictionary that contains the parameters for land-sea-mask channel selection
        """
        super().__init__()
        self.device = None
