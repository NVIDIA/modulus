...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Specify which part to capture",
    )
    parser.add_argument(
        "--capture_range_start", default=1, type=int, help="Profile range start step"
    )
    parser.add_argument(
        "--capture_range_stop", default=1, type=int, help="Profile range stop step"
    )
    parser.add_argument(
        "--capture_ranks",
        default=[0],
        type=int,
        nargs="+",
        help="Profile ranks from that list",
    )
