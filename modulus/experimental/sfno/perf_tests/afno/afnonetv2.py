...
def main(args, verify):
    ...
    # blocks
    model_loc = AdaptiveFourierNeuralOperatorNet(inp_chans=args.channels,
                                                 out_chans=args.channels,
                                                 img_size=(H, W),
    ...
    #input
    inp_loc = torch.empty((batch_size, args.channels, H, W), dtype=torch.float32, device=device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_blocks", default=8, type=int, help="Number of transformer heads")
    parser.add_argument("--embed_dim", default=256, type=int, help="Embedding dim")
    ...
    parser.add_argument("--channels", default=20, type=int, help="Input and output channels")
