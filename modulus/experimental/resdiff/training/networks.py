...
class UNetBlock(torch.nn.Module):
    def __init__(self,
        ...
        # dist.print0('attention', attention)
        # dist.print0('in_channels', in_channels)
        # dist.print0('out_channels', out_channels)
...
class SongUNet(torch.nn.Module):
    def __init__(self,
        ...
        #dist.print0('emb_channels', emb_channels)
    ...
    def forward(self, x, noise_labels, class_labels, augment_labels=None):
        ...
        # dist.print0('noise_labels', noise_labels.shape)
        # dist.print0('emb', emb.shape)
        # dist.print0('torch.norm(emb)', torch.norm(emb))
...
class EDMPrecond(torch.nn.Module):
    def __init__(self,
        ...
        **model_kwargs,                     # Keyword arguments for the underlying model.
        ...
        self.model = globals()[model_type](img_resolution=img_resolution, in_channels=img_in_channels+img_out_channels, out_channels=img_out_channels, label_dim=label_dim, **model_kwargs)

    def forward(self, x, img_lr, sigma, class_labels=None, force_fp32=False, **model_kwargs):
