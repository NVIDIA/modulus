...
try:
    ...
    raise ImportError("Please install the edmss package (internal), or get the non-commercial version of the edm sampler from this repo: https://github.com/NVlabs/edm")
...
def get_dataset_and_sampler(data_type, data_config):
...
def main(max_times: Optional[int], seeds: List[int], **kwargs):
    ...
    # Data
    params = YParams(opts.data_type + '.yaml', config_name=opts.data_config)
