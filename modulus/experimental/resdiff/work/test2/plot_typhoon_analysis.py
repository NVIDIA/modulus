...
diffusion = nc.Dataset('/lustre/fsw/sw_climate_fno/yacohen/diffusion/generations/era5-cwb-v3/typhoons/Chanthu2021.nc', 'r')
...
for tc_time in range(len(true_rmw_list)-1):
    ...
    plt.tight_layout()
    plt.savefig(f"/code/typhoon_Chanthu2021_{time_str[tc_time]}.pdf", dpi=100)
