...
def plot_ifs_acc_comparison(acc_curve, params, epoch):
    ...
    import os
    ifs_comparison_dict = {'u10m': 'u10_2018_acc.npy', 'v10m': 'v10_2018_acc.npy', 'z500': 'z500_2018_acc.npy', 't2m': 't2m_2018_acc.npy', 't850': 't850_2018_acc.npy'}

    for comparison_var, comparison_file in ifs_comparison_dict.items():

        ifs_acc_file = os.path.join(params.ifs_acc_path, comparison_var, comparison_file)
...
class VisualizationWrapper(object):
    ...
    def __init__(self, log_to_wandb, path, prefix, plot_list, scale=1., bias=0., num_workers=1):
