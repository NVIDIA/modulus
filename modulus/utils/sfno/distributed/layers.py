...
from modulus.utils.sfno.distributed.helpers import pad_helper
from modulus.utils.sfno.distributed.helpers import truncate_helper 
...
class DistributedMLP(nn.Module):
    def __init__(self, in_features,
        ...
        self.act = act_layer()
        self.drop = nn.Dropout(drop) if drop_rate > 0. else nn.Identity()
        ...
        if output_bias:
            self.b2.is_shared_mp = ["matmul", "h", "w"] # this one is shared between all ranks
