...
class DummyLoader(object):
    ...
    def _get_files_stats(self):
        ...
        # compute padding
        read_pad_x = (self.img_crop_shape_x + self.io_grid[1] - 1) // self.io_grid[1] - read_shape_x
        read_pad_y = (self.img_crop_shape_y + self.io_grid[2] - 1) // self.io_grid[2] - read_shape_y
        ...
        logging.info("Found data at path {}. Number of examples: {}. Image Shape: {} x {} x {}".format(self.location, self.n_samples_total, self.img_shape_x, self.img_shape_y, self.n_in_channels_local))
