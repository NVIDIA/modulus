...
```bash
wget --content-disposition https://api.ngc.nvidia.com/v2/resources/nvidia/physicsnemo/modulus_datasets_cylinder-flow/versions/v1/zip -O modulus_datasets_cylinder-flow_v1.zip
