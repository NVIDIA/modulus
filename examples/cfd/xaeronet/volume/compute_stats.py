...
def compute_global_stats(h5_files, num_workers=4):
    ...
    with ProcessPoolExecutor(max_workers=num_workers) as executor:
        results = list(tqdm(executor.map(process_file, h5_files), total=len(h5_files), desc="Processing H5 Files", unit="file"))
...
def main(cfg: DictConfig) -> None:
    ...
    global_mean, global_std = compute_global_stats(h5_files, num_workers=cfg.num_preprocess_workers)
