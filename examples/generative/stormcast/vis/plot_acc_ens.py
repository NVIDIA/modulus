...
c = idxes[fld]
config1 = 'paper/1'
#config1 = 'paper_precip/0' # precip config
...
filenames += [config2 + "/ens_autoregressive_predictions_0.3_100ens_"+fld+"_vis.h5"]
filenames += [config3 + "/ens_autoregressive_predictions_0.02_100ens_"+fld+"_vis_pink4.h5"]
#filenames += [config3 + "/ens_autoregressive_predictions_0.05_100ens_"+fld+"_mult.h5"]
#filenames += [config3 + "/ens_autoregressive_predictions_0.02_100ens_"+fld+"_pink4.h5"]
...
labels = ["base", "ens-0.3-ic0", "ens-0.02-ic0"]
...
fig.tight_layout()
file_nm = os.path.join(*[basepath, "ensic0_fourcastnet_accrmse_"+fld+".pdf"])
