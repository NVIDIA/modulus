...
def run_forecast(
    model_shortname: str = "diffusion_regression_a2a_v3_1_exclude_w_pstep_pos_embed_noema",
    output_directory: str = "./diffusion_regression_a2a_v3_1_exclude_w_pstep_pos_embed_noema",
    device: str = "cuda:0",
    n_steps: int = 6,
    output_hrrr_channels: list[str] = [],
    initial_time: datetime = datetime(2024, 5, 9, 18, 0),
):
    ...
    if edm_params.regression_net_type == "unet":
    ...
    group.array("latitude", data=dataset.hrrr_latitudes)
    group.array("longitude", data=dataset.hrrr_longitudes)
